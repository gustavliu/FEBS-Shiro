...
CREATE TABLE `t_reservation` (
                               `RESERVATION_ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '预约单ID',
                               `ORGANIZATION` varchar(50) NOT NULL COMMENT '单位',
                               `SYSTEM` varchar(50) NOT NULL COMMENT '所属系统',
                               `CONTACT` varchar(50) NOT NULL COMMENT '联系人',
                               `PHONE` varchar(20) DEFAULT NULL COMMENT '联系电话',
                               `VISITOR_NUM` int DEFAULT NULL COMMENT '参观人数',
                               ...
                               `WITH_NARRATOR` BOOL DEFAULT NULL COMMENT '是否需要解说员',
                               `STATUS` varchar(20) DEFAULT NULL COMMENT '预约单状态',
